...
export const products = [
  ...
  product('maestro-case', 'Maestro Case', 'Preview',
    ...
    ['Studio Web lists Maestro Case as a preview project type in July 2026.', 'Case work differs from a fixed sequence because events and judgment can alter the path.'],
    ['july-release', 'platform'],
